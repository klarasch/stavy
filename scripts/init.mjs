...
writeFileSync(
  ...
  `/* Stavy viewer styles — generated by init. Import once from main.tsx. */
...
3. main.tsx — just: import "./stavy.css" and render <App />.
   ...
   imports: ChromeProvider, EyeToggle from "./stavy/chrome"; CommentsProvider from
   "./stavy/comments/store"; CanvasPage from "./stavy/canvas/CanvasPage"; PageView from "./stavy/PageView".
